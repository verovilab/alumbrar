...
export const GEMAS: Gema[] = [
  ...
  },
  {
    ...
    idea: "Cada persona es un espejo. Si ves luz en ellos, estás reconociendo la luz que ya brilla en ti.",
  ...
  },
  {
    id: 29,
    phrase: "Veo tu luz.",
    idea: "La luz in ti reconoce la luz in otros.",
  ...
  },
  {
    ...
    idea: "No in el pasado ni in el futuro.",
