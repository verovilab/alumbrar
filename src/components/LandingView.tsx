    ...
    <div className="min-h-screen text-mystic flex flex-col items-center justify-center font-inter pt-8 md:pt-14 relative overflow-hidden">
      ...
      <div className="w-24 h-24 rounded-full bg-[#D4AF37] flex items-center justify-center shadow-[0_0_60px_rgba(212,175,55,0.4)] animate-pulse-slow">
        ...
        <div className="space-y-4">
          <h1 className="text-6xl md:text-9xl font-serif italic gold-text tracking-tighter mystic-halo">Alumbrar</h1>
          <p className="text-xs md:text-base text-[#D4AF37] uppercase tracking-[0.6em] font-black opacity-100 decoration-[#D4AF37]/40 underline-offset-8 underline mystic-halo">Santuario de Paz Interior</p>
        </div>
